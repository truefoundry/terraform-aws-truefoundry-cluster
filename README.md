...
| <a name="input_cluster_addons_node_monitoring_agent_additional_configurations"></a> [cluster\_addons\_node\_monitoring\_agent\_additional\_configurations](#input\_cluster\_addons\_node\_monitoring\_agent\_additional\_configurations) | Additional configurations for the node monitoring agent addon | `any` | `{}` | no |
| <a name="input_cluster_addons_node_monitoring_agent_enable"></a> [cluster\_addons\_node\_monitoring\_agent\_enable](#input\_cluster\_addons\_node\_monitoring\_agent\_enable) | Enable the EKS Node Monitoring Agent addon for node health monitoring and auto repair | `bool` | `false` | no |
| <a name="input_cluster_addons_node_monitoring_agent_version"></a> [cluster\_addons\_node\_monitoring\_agent\_version](#input\_cluster\_addons\_node\_monitoring\_agent\_version) | Version of the EKS Node Monitoring Agent addon | `string` | `"v1.4.0-eksbuild.2"` | no |
