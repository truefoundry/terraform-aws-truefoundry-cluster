...
| <a name="input_disable_default_tags"></a> [disable\_default\_tags](#input\_disable\_default\_tags) | Set to true to disable the default module tags (terraform, terraform-module, cluster-name). Only var.tags will be applied. | `bool` | `false` | no |
