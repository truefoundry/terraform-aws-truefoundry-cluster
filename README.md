...
| <a name="input_cluster_addons_node_monitoring_agent_enable"></a> [cluster\_addons\_node\_monitoring\_agent\_enable](#input\_cluster\_addons\_node\_monitoring\_agent\_enable) | Enable the EKS Node Monitoring Agent addon for node health monitoring and auto repair | `bool` | `true` | no |
| <a name="input_cluster_addons_node_monitoring_agent_version"></a> [cluster\_addons\_node\_monitoring\_agent\_version](#input\_cluster\_addons\_node\_monitoring\_agent\_version) | Version of the EKS Node Monitoring Agent addon | `string` | `"v1.0.0-eksbuild.1"` | no |
